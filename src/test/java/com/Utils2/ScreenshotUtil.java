...
public class ScreenshotUtil {
    ...
    /**
     * Cleans up old screenshots (optional - call before test suite)
    ...
    public static void cleanupScreenshots() {
        try {
            ...
            if (directory.exists()) {
                ...
                System.out.println("Screenshot directory cleaned: " + SCREENSHOT_DIR);
            }
        } catch (IOException e) {
            System.err.println("Failed to cleanup screenshot directory: " + e.getMessage());
        }
    }
     ...
     *
     * @param days Number of days to retain screenshots
     */
    public static void deleteOldScreenshots(int days) {
        try {
            ...
            System.err.println("Failed to delete old screenshots: " + e.getMessage());
        }
    }
