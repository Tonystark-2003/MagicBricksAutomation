...
public class ReportManager extends BaseSetup {
    ...
    public void reportGeneration() {
        try {
            ...
            String reportPath = REPORT_DIR + "MagicBricksReport_" + timestamp + ".html";
            sparkReport = new ExtentSparkReporter(reportPath);

            // Configure Extent Reports
            sparkReport.config().setTheme(Theme.DARK);
            sparkReport.config().setDocumentTitle("MagicBricks Automation Report");
    ...
    public void reportTestCreation(Method method, ITestContext context) {
        try {
            ...
            extentTest.assignAuthor("Shubham Pedhe");
